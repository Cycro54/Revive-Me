...
public class FallenCapability {
    ...
    public static final String PENALTY_INT = "penaltyIntREVIVE";
    ...
    public void setPenalty(PENALTYPE type, int amount){
    ...
    public INBT writeNBT(){
        ...
        cNBT.putInt(PENALTY_INT, this.penaltyAmount);
    ...
    public void readNBT(INBT nbt){
        ...
        this.setPenalty(PENALTYPE.valueOf(cNBT.getString(PENALTY_ENUM)), cNBT.getInt(PENALTY_INT));
    ...
    public static class FallenNBTStorage implements Capability.IStorage<FallenCapability> {
        ...
        public INBT writeNBT(Capability<FallenCapability> capability, FallenCapability instance, Direction side) {
            ...
            cNBT.putInt(PENALTY_INT, instance.penaltyAmount);
            return cNBT;
        }
        ...
        public void readNBT(Capability<FallenCapability> capability, FallenCapability instance, Direction side, INBT nbt) {
            ...
            try {
                instance.setPenalty(PENALTYPE.valueOf(cNBT.getString(PENALTY_ENUM)), cNBT.getInt(PENALTY_INT));
            }
